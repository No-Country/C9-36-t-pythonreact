...
Se arreglaron detalles de la vista del login/register en version mobile y desktop
Se instalo la dependencia motion para animaciones y se agregaron animacion a la carga del dashboard
}
